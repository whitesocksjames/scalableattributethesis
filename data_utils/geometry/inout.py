...
def read_coords(filedir, dtype='int32'):
    if filedir.endswith('h5'): coords = read_h5(filedir, dtype=dtype)
    if filedir.endswith('ply'): coords = read_ply_o3d(filedir, dtype=dtype)
