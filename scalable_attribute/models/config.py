...
def add_base_architecture_arguments(parser):
    """Compatibility CLI helper; planned home: ``runtime.cli``.

    ``BaseSynthesisConfig`` is the architecture contract.  Argument-parser
    integration remains here only while recorded command lines still import
    this symbol through the historical canonical module.
    """
